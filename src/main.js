...
var app = new Vue({
   ...
   mounted() {
      ...
      axios({
         method: 'get',
         url: 'https://maria93:e8umh8@opensky-network.org/api/states/all?time=1458564121&icao24=3c6444'
      }).then(response => (this.states = response.data))
    },
    methods: {
         initMap() {
          this.map = L.map('map').setView([38.63, -90.23], 12);this.tileLayer = L.tileLayer(
